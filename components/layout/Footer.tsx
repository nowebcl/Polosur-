        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 text-xs sm:text-sm mb-6 leading-relaxed">
              Ingeniería de tránsito y evaluación ambiental para proyectos que construyen un futuro más sostenible y conectado en Chile.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link className="text-gray-400 hover:text-white transition-colors" href="/proyectos">Proyectos</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link className="text-gray-400 hover:text-white transition-colors" href="/servicios/imiv">IMIV</Link></li>
              <li><Link className="text-gray-400 hover:text-white transition-colors" href="/servicios/movilidad">Estudios de Movilidad</Link></li>
              <li><Link className="text-gray-400 hover:text-white transition-colors" href="/servicios/modelacion">Modelación de Tránsito</Link></li>
              <li><Link className="text-gray-400 hover:text-white transition-colors" href="/servicios/ambiental">Evaluación Ambiental</Link></li>
              <li><Link className="text-gray-400 hover:text-white transition-colors" href="/servicios/normativa">Asesoría Normativa</Link></li>
              <li><Link className="text-gray-400 hover:text-white transition-colors" href="/servicios/diseno">Diseño de Soluciones</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-400 font-mono text-xs">+56 9 1234 5678</span>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 text-gray-500 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
                </svg>
                <span className="text-gray-400 font-mono text-xs">contacto@polosur.cl</span>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 text-gray-500 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-gray-400 text-xs">Av. Providencia 1234, Of. 502<br/>Providencia, Santiago, Chile</span>
              </li>
            </ul>
          </div>
